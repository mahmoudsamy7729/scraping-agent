...
SLUG = "scrapling-agent"
NAME = "Scrapling Agent"
DESCRIPTION = "Agent responsible for scraping structured data from websites."
MODEL = "gpt-oss:120b-cloud"


async def seed_scraping_agent() -> None:
    ...
    async with session_factory() as session:
        ...
        print(f"Scraping agent {action}: {SLUG}")

    await engine.dispose()


if __name__ == "__main__":
    asyncio.run(seed_scraping_agent())
